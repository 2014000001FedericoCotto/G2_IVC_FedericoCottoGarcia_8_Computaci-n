 ...
 * @author Usuario
 */
public class jfrmCalcbasica extends javax.swing.JFrame {
    ...
    /**
     * Creates new form jfrmCalcbasica
     */
    public jfrmCalcbasica() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jbtnporcentaje.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        ...
        jbtnc.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        jbtnc.setText("c");
        ...
        jbtnraiz.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        jbtnraiz.setText("R");
        ...
        jbtnpunto.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        jbtnpunto.setText(".");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(jbtnac, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGap(29, 29, 29))
                        .addComponent(jbtnigual, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jbtnporcentajeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnporcentajeActionPerformed
        ...
        re= (numero1/100);
        operador="%";
        jtxtresultado.setText(String.valueOf(re));
    ...
    private void jbtncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtncActionPerformed
        // TODO add your handling code here:
          String txt = jtxtresultado.getText();
    if (txt.length() > 1) {
        txt = txt.substring(0, txt.length() - 1);
        jtxtresultado.setText(txt);
            qwerty = true;
        }else {
            jtxtresultado.setText("0");
        }
    ...
    if (!operador.equals("")) {
        ...
        jtxtresultado.setText(String.valueOf(numero1));
...
operador = "/";
        ...
        if (operador.equals("/")) {
         ...
         if (operador.equals("R")) {
            ...
            jtxtresultado.setText(entrada);
             ...
             }else{jtxtresultado.setText("Syntax error");}
        }
         if (operador.equals("%")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfrmCalcbasica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfrmCalcbasica().setVisible(true);
            }
        });
    }
